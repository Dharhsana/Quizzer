...
CREATE TABLE IF NOT EXISTS `quizApp_db`.`student_has_classroom` (
  ...
  `classroom_id` INT NOT NULL,
  PRIMARY KEY (`student_name`, `classroom_id`),
  INDEX `fk_student_has_classroom_classroom1_idx` (`classroom_id` ASC) VISIBLE,
  INDEX `fk_student_has_classroom_student1_idx` (`student_name` ASC) VISIBLE,
  CONSTRAINT `fk_student_has_classroom_student1`
    FOREIGN KEY (`student_name`)
    REFERENCES `quizApp_db`.`student` (`name`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `quizApp_db`.`student_has_quiz` (
  `quiz_id` INT NOT NULL,
  `attempt` INT NULL,
  `student_has_quizcol` INT NOT NULL,
  `result` VARCHAR(45) NULL,
  `grade` VARCHAR(45) NULL,
  PRIMARY KEY (`quiz_id`, `student_has_quizcol`),
  INDEX `fk_student_has_quiz_quiz1_idx` (`quiz_id` ASC) VISIBLE,
  INDEX `fk_student_has_quiz_quiz2_idx` (`student_has_quizcol` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_student_has_quiz_quiz2`
    FOREIGN KEY (`student_has_quizcol`)
